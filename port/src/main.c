...
PD_CONSTRUCTOR static void gameConfigInit(void)
{
	...
	configRegisterInt("Game.UnlimitedCorpses", &g_UnlimitedCorpses, 0, 1);
	configRegisterInt("Game.UnlimitedBulletHoles", &g_UnlimitedWallhits, 0, 1);
	configRegisterInt("Game.LaserScorchMarks", &g_LaserScorchMarks, 0, 1);
