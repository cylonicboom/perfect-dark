...
- `CHEAT_NOCULL 43`, `CHEAT_NODRAWLIMIT 44` — appended after all original cheat indices
- `CHEATFLAG_ALWAYSUNLOCKED 16` — new flag bit, absent from the original
- `MPOPTION_NOCULL 0x10000000`, `MPOPTION_NOOMLIMIT 0x20000000` — new MP option bits in the upper word
